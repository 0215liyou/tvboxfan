...
<body>
    <div class="container">
        <h1 class="text-center mb-5">全能接口解密</h1>
        ...
        <div class="text-center mt-3">
             <a href="https://饭太硬.top"  target="_blank"class="btn btn-primary">主页</a>
             <button class="btn btn-warning" onclick="copyText()">复制</button>
             <!--<button class="btn btn-success" onclick="downloadJar()">下载Jar</button>-->
            <a href="https://mp.weixin.qq.com/s/nP3-qdiuHuGCh3rXE8qLDw"  target="_blank"class="btn btn-danger">饭太硬公众号</a>
    ...
    <script>
        function crawl() {
           ...
           xhr.open("GET", "./jiemi.php?url=" + encodeURIComponent(url), true);  
